            ...
            content: [
              {
                ...
                text: [
                  ...
                  "condition MUST be EXACTLY one of: New with tags, New without tags, Excellent, Good, Fair.",
                  "Use those exact strings (matching case and spacing) or leave the field empty.",
                ].join("\n"),
              },
